...
export async function initDb(): Promise<void> {
  ...
  db.run(`
    CREATE TABLE IF NOT EXISTS players (
      ...
      name TEXT NOT NULL,
      rank TEXT NOT NULL DEFAULT '暂无段位',
      avatar_url TEXT,
  ...
  db.run(`
    CREATE TABLE IF NOT EXISTS tournaments (
      ...
      group_format TEXT NOT NULL DEFAULT 'swiss' CHECK(group_format IN ('swiss', 'double_elim', 'round_robin')),
      knockout_format TEXT NOT NULL DEFAULT 'swiss' CHECK(knockout_format IN ('swiss', 'double_elim', 'round_robin')),
